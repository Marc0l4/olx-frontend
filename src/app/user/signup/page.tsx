...
const Page = () => {
    ...
    const handleFormSubmit: SubmitHandler<SignUpInputs> = async (data) => {
        ...
        if (!json.data.error) {
            ctx.setToken(json.data.token ? json.data.token : false)
            setDisabled(false);
    ...
    return (
        <PageContainer>
            ...
            <div className="flex justify-center items-center">
                ...
                >
                    <label className="flex items-center p-3 max-w-sm">
                    ...
                    <label className="flex p-3 max-w-lg md:ml-16">
                        ...
                        <div className="flex-1">
                            <button disabled={disabled} className="rounded-md text-white bg-blue-500 py-2 px-3 
                                hover:bg-blue-700 hover:transition-all hover:ease-in-out">Cadastrar</button>
                        </div>
                    </label>
                </form>
            </div>
